/*
  ...
  - Added the required column `contributorGitId` to the `ContributorRepos` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_ContributorRepos" (
    ...
    "contributorGitId" INTEGER NOT NULL,
